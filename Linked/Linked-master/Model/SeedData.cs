...
namespace Linked.Models{
    public static class SeedData{
        public static void Initialize(IServiceProvider serviceProvider){
            ...
            //     //     Specialty = Specialty.Director, Level = Level.Avanzado, ClientID = 1, Description = "Reclame de 5 minutos", CompletionStatus = false},
            //     //     new Project { Title = "Propaganda Copa América", Date = DateTime.Parse("2019-03-02"),
            //     //     Specialty = Specialty.Actor, Level = Level.Básico, ClientID = 2, Description = "Titulares y Highlights de la Copa 2015", CompletionStatus = false},
            //     //     new Project { Title = "Kung Fu Panda 5", Date = DateTime.Parse("2019-07-03"),
            //     //     Specialty = Specialty.Camarógrafo, Level = Level.Intermedio, ClientID = 3, Description = "Trailer de la nueva Película", CompletionStatus = false},
            //     //     new Project { Title = "Open Fing Clases", Date = DateTime.Parse("2019-11-04"),
            //     //     Specialty = Specialty.Sonidista, Level = Level.Profesional, ClientID = 4, Description = "Grabar Curso 779283 completo ", CompletionStatus = false},
            //     //     new Project { Title = "Toy Story 5", Date = DateTime.Parse("2019-12-05"),
            //     //     Specialty = Specialty.Director, Level = Level.Intermedio, ClientID = 5, Description = "Trailer de la Nueva Pelicula de Pixar", CompletionStatus = false},
            //     //     new Project { Title = "Mi Villano Favorito", Date = DateTime.Parse("2019-10-04"),
            //     //     Specialty = Specialty.Director, Level = Level.Intermedio, ClientID = 6, Description = "Mindstorming de la nueva Película", CompletionStatus = false},
            //     //     new Project { Title = "Podcast con Alumnos", Date = DateTime.Parse("2019-04-06"),
            //     //     Specialty = Specialty.Camarógrafo, Level = Level.Básico, ClientID = 7, Description = "Entrevistas casuales acerca de la vida estudiantil en UCU", CompletionStatus = true},
            //     //     new Project { Title = "VideoClip Musical Survivors", Date = DateTime.Parse("2019-09-07"),
            //     //     Specialty = Specialty.Actor, Level = Level.Avanzado, ClientID = 8, Description = "Filmar el nuevo videoclip para Survivors", CompletionStatus = false},
            //     // };
            ...
            //         Specialty = Specialty.Director, Level = Level.Avanzado},
            //         new Technician { Name = "Sergio Pérez", Birthday = DateTime.Parse("1986-07-02"), 
            //         Specialty = Specialty.Camarógrafo, Level = Level.Profesional},
            //         new Technician { Name = "Camila Fernández", Birthday = DateTime.Parse("1974-08-03"), 
            //         Specialty = Specialty.Sonidista, Level = Level.Básico},
            ...
            //         Specialty = Specialty.Fotógrafo, Level = Level.Intermedio},
            ...
            //         Specialty = Specialty.Director, Level = Level.Profesional}
            //     };
